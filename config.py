...
SYSTEM_PROMPT = (
    ...
    "- You have access to tools, including a web search tool. If you are not "
    "fully confident in an answer, especially anything involving current "
    "events, dates after your training, scores, prices, or specific facts, "
    "search for it rather than guessing or saying you don't know. Answer "
    "directly and naturally from what you already know for greetings, small "
    "talk, opinions, and general conversation."
)